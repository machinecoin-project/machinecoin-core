...
class SegWitTest(MachinecoinTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--oldbinary", dest="oldbinary",
                          default=None,
                          help="pre-segwit machinecoind binary for upgrade testing")
    ...
    def setup_network(self):
        ...
        # If an old machinecoind is given, do the upgrade-after-activation test.
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, machinecoind delays sending reject messages for blocks
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-machinecoind> to
    # the test.
    def test_upgrade_after_activation(self, node, node_id):
        print("\tTesting software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active machinecoind
