...
MacOSX:
* OSX support for click-to-pay (machinecoin:) links
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the Machinecoin-Qt debug
console will cause Machinecoin-Qt to crash. Run Machinecoin-Qt with the -server command-line
