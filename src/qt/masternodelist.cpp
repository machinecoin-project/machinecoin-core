...
void MasternodeList::updateMyMasternodeInfo(QString strAlias, QString strAddr, const COutPoint& outpoint)
{
    ...
    QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(fFound ? EncodeDestination(GetDestinationForKey(infoMn.pubKeyCollateralAddress, OUTPUT_TYPE_P2SH)) : ""));
...
void MasternodeList::updateNodeList()
{
    ...
    for(auto& mnpair : mapMasternodes)
    {
        ...
        QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(EncodeDestination(GetDestinationForKey(mn.pubKeyCollateralAddress, OUTPUT_TYPE_P2SH))));
