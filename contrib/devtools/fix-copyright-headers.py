...
// Copyright (c) 2009-2012 The Machinecoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Machinecoin/$1-%s The Machinecoin/' %s"
REGEX_CURRENT= re.compile("%s The Machinecoin" % year)
