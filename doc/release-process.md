...
### Fetch and create inputs: (first time, or when dependency versions change)
    ...
    pushd ./gitian-builder
    mkdir -p inputs
    wget -P inputs https://machinecoin.org/cfields/osslsigncode-Backports-to-1.7.1.patch
...
- Announce the release:
  ...
  - Machinecoin Core announcements list https://machinecoin.org/en/list/announcements/join/

  - machinecoin.org blog post
