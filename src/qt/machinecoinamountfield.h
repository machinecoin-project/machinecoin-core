...
/** Widget for entering machinecoin amounts.
  */
class MachinecoinAmountField: public QWidget
{
    Q_OBJECT
...
public:
    explicit MachinecoinAmountField(QWidget *parent = 0);
...
#endif // MACHINECOIN_QT_MACHINECOINAMOUNTFIELD_H
