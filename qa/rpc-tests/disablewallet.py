...
class DisableWalletTest (MachinecoinTestFramework):
    ...
    def run_test (self):
        # Check regression: https://github.com/machinecoin-project/machinecoin-core/issues/6963#issuecomment-154548880
