...
*Setup instructions for a Gitian build of Machinecoin using a Debian VM or physical system.*
...
- [Building Machinecoin](#building-machinecoin)
...
Clone the git repositories for machinecoin and Gitian and then checkout the machinecoin version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/machinecoin-project/machinecoin-core.git machinecoin
cd machinecoin
...
Follow the instructions in [doc/release-process.md](release-process.md) in the machinecoin repository
...
To build Machinecoin (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md) in the machinecoin repository.
...
For example:
```bash
URL=https://github.com/user/machinecoin.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/machinecoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/machinecoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/machinecoin-build.assert
```
