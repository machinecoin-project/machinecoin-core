...
class BIP66Test(MachinecoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # machinecoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and machinecoind produces more specific reject
            # reasons.
