...
BENCHMARK(BLSPubKeyAggregate_Normal, 5000)
BENCHMARK(BLSSecKeyAggregate_Normal, 5000)
BENCHMARK(BLSSign_Normal, 5000)
BENCHMARK(BLSVerify_Normal, 5000)
BENCHMARK(BLSVerify_LargeBlock1000, 5000)
BENCHMARK(BLSVerify_LargeBlockSelfAggregated1000, 5000)
BENCHMARK(BLSVerify_LargeBlockSelfAggregated10000, 5000)
BENCHMARK(BLSVerify_LargeAggregatedBlock1000, 5000)
BENCHMARK(BLSVerify_LargeAggregatedBlock10000, 5000)
BENCHMARK(BLSVerify_LargeAggregatedBlock1000PreVerified, 5000)
BENCHMARK(BLSVerify_Batched, 5000)
BENCHMARK(BLSVerify_BatchedParallel, 5000)
