...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("machinecoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'machinecoin://' is not a valid URI. Use 'machinecoin:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(MACHINECOIN_IPC_PREFIX, Qt::CaseInsensitive)) // machinecoin: URI
    {
