...
- The Ubuntu PPA from https://launchpad.net/~machinecoin/+archive/ubuntu/machinecoin
- A third-party or self-compiled Machinecoin Core

upgrade to Machinecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
