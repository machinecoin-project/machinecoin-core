...
To receive security and update notifications, please subscribe to:
  ...
  <https://machinecoin.org/en/list/announcements/join/>
...
compatible peers.
[MIP 152](https://github.com/machinecoin-project/mips/blob/master/mip-0152.mediawiki)
...
[Pull request](https://github.com/machinecoin-project/machinecoin-core/pull/8035/files), [MIP 32](https://github.com/machinecoin-project/mips/blob/master/mip-0032.mediawiki)


Segregated Witness
------------------

The code preparations for Segregated Witness ("segwit"), as described in [MIP
141](https://github.com/machinecoin-project/mips/blob/master/mip-0141.mediawiki), [MIP
143](https://github.com/machinecoin-project/mips/blob/master/mip-0143.mediawiki), [MIP
144](https://github.com/machinecoin-project/mips/blob/master/mip-0144.mediawiki), and [MIP
145](https://github.com/machinecoin-project/mips/blob/master/mip-0145.mediawiki) are
finished and included in this release.  However, MIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after MIP 141 is updated with
...
maximum "block weight" of a generated block, as defined by [MIP 141 (Segregated
Witness)] (https://github.com/machinecoin-project/mips/blob/master/mip-0141.mediawiki).
...
`-blockmaxsize`.  See [MIP 141]
(https://github.com/machinecoin-project/mips/blob/master/mip-0141.mediawiki) for additional
details.)
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/machinecoin-project/bips/blob/master/bip-0133.mediawiki)
...
- Asm script outputs replacements for OP_NOP2 and OP_NOP3
  ...
  - OP_NOP2 has been renamed to OP_CHECKLOCKTIMEVERIFY by [MIP 
65](https://github.com/machinecoin-project/mips/blob/master/mip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [MIP 
112](https://github.com/machinecoin-project/mips/blob/master/mip-0112.mediawiki)
