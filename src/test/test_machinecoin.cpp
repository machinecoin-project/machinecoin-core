...
#define BOOST_TEST_MODULE Machinecoin Test Suite

#include "test_machinecoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_machinecoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
