...
const char * const MACHINECOIN_PID_FILENAME = "machinecoind.pid";
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", MACHINECOIN_CONF_FILENAME));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", MACHINECOIN_PID_FILENAME));
...
void SetThreadPriority(int nPriority) // Machinecoin: internal miner
{
#ifdef WIN32
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strCopyrightHolders.find("Machinecoin Core developers") == strCopyrightHolders.npos) {
