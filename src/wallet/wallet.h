...
public:
     ...
     */
    void AvailableMNCoins(std::vector<COutput>& vCoins, bool fOnlySafe=true, const CCoinControl *coinControl = nullptr, const CAmount& nMinimumAmount = 20000000000, const CAmount& nMaximumAmount = 20000000000, const CAmount& nMinimumSumAmount = MAX_MONEY, const uint64_t nMaximumCount = 0, const int nMinDepth = 0, const int nMaxDepth = 9999999) const;
    ...
    // Masternodes
    // Get 200 MAC output and keys which can be used for the Masternode
