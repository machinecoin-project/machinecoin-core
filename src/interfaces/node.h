...
#ifndef MACHINECOIN_INTERFACES_NODE_H
#define MACHINECOIN_INTERFACES_NODE_H
...
//! Top-level interface for a machinecoin node (machinecoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Register handler for additional sync progress.
...
#endif // MACHINECOIN_INTERFACES_NODE_H
