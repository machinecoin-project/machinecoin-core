...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage MCDhvmufxFMUDEWzpEYQAEQun13jK2kBsf mymessage"), runtime_error);

    /* missing arguments */
    BOOST_CHECK_THROW(CallRPC("verifymessage " + demoAddress.ToString()), runtime_error);
    BOOST_CHECK_THROW(CallRPC("verifymessage " + demoAddress.ToString() + " " + retValue.get_str()), runtime_error);
    /* Illegal address */
    BOOST_CHECK_THROW(CallRPC("verifymessage MRr7DA8mQLHuzUDmnMSs6WW1D4yJnDMLK " + retValue.get_str() + " mymessage"), runtime_error);
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage MRr7DA8mQLHuzUDmnMSs6WW1D4yJnDMLKM " + retValue.get_str() + " mymessage").get_bool() == false);
