...
unsigned int GetNextWorkRequired_V3(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params&); // Machinecoin: Octopus retargeting (V3)
...
unsigned int CalculateNextWorkRequired_V3(const CBlockIndex* pindexLast, const CBlockHeader *pblock, int64_t nBlockTimeO, int64_t nFirstBlockTime, const Consensus::Params&); // Machinecoin: Octopus retargeting (V3)
