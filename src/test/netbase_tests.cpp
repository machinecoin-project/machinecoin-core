...
{
    BOOST_CHECK(TestSplitHost("www.machinecoincore.org", "www.machinecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.machinecoincore.org]", "www.machinecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.machinecoincore.org:80", "www.machinecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.machinecoincore.org]:80", "www.machinecoincore.org", 80));
