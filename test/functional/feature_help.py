...
"""Verify that starting machinecoin with -h works as expected."""

from test_framework.test_framework import MachinecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(MachinecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start machinecoin with -h for help text")
        ...
        self.log.info("Start machinecoin with -version for version information")
        ...
        self.log.info("Start machinecoind with -fakearg to make sure it does not start")
