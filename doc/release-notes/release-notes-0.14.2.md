Machinecoin Core version 0.14.2 is now available from:

  <https://machinecoin.org/bin/machinecoin-core-0.14.2/>
...
(in Machinecoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Machinecoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate machinecoin-config.h as necessary (theuni)
