...
void MasternodeList::updateNodeList()
{
    ...
    for(auto& mnpair : mapMasternodes)
    {
        ...
        QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(EncodeDestination(CScriptID(GetScriptForDestination(mn.pubKeyCollateralAddress.GetID())))));
