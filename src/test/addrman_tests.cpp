...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    CService addr1 = CService("250.1.1.1", 40333);
    ...
    CService addr1_dup = CService("250.1.1.1", 40333);
    ...
    //  have two addrs.
    CService addr2 = CService("250.1.1.2", 40333);
...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr2 = CService("250.3.1.1", 40333);
    CService addr3 = CService("250.3.2.2", 9999);
    CService addr4 = CService("250.3.3.3", 9999);

    addrman.Add(CAddress(addr2, NODE_NONE), CService("250.3.1.1", 40333));
    addrman.Add(CAddress(addr3, NODE_NONE), CService("250.3.1.1", 40333));
    addrman.Add(CAddress(addr4, NODE_NONE), CService("250.4.1.1", 40333));

    // Add three addresses to tried table.
    CService addr5 = CService("250.4.4.4", 40333);
    CService addr6 = CService("250.4.5.5", 7777);
    CService addr7 = CService("250.4.6.6", 40333);

    addrman.Add(CAddress(addr5, NODE_NONE), CService("250.3.1.1", 40333));
    addrman.Good(CAddress(addr5, NODE_NONE));
    addrman.Add(CAddress(addr6, NODE_NONE), CService("250.3.1.1", 40333));
    addrman.Good(CAddress(addr6, NODE_NONE));
    addrman.Add(CAddress(addr7, NODE_NONE), CService("250.1.1.3", 40333));
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr1 = CAddress(CService("250.1.2.1", 40333), NODE_NONE);
    CAddress addr2 = CAddress(CService("250.1.2.1", 9999), NODE_NONE);
    CAddress addr3 = CAddress(CService("251.255.2.1", 40333), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr1 = CAddress(CService("250.250.2.1", 40333), NODE_NONE);
    addr1.nTime = GetAdjustedTime(); // Set time so isTerrible = false
    CAddress addr2 = CAddress(CService("250.251.2.2", 9999), NODE_NONE);
    addr2.nTime = GetAdjustedTime();
    CAddress addr3 = CAddress(CService("251.252.2.3", 40333), NODE_NONE);
    addr3.nTime = GetAdjustedTime();
    CAddress addr4 = CAddress(CService("252.253.3.4", 40333), NODE_NONE);
    addr4.nTime = GetAdjustedTime();
    CAddress addr5 = CAddress(CService("252.254.4.5", 40333), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket)
{
    ...
    CAddress addr1 = CAddress(CService("250.1.1.1", 40333), NODE_NONE);
