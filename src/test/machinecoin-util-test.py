...
# Copyright 2016 The Machinecoin Core developers
...
help_text="""Test framework for machinecoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/machinecoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "machinecoin-util-test.json", buildenv)
