...
static void SetupMachinecoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " machinecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  machinecoin-tx [options] <hex-tx> [commands]  Update hex-encoded machinecoin transaction\n" +
            "or:     machinecoin-tx [options] -create [commands]   Create hex-encoded machinecoin transaction\n" +
            "\n";
