Machinecoin Core version 0.16.1 is now available from:

  <https://machinecoincore.org/bin/machinecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting machinecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure machinecoind processes are cleaned up when tests end (sdaftuar)
