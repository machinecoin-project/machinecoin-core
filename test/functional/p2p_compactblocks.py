...
# TestP2PConn: A peer we use to send messages to machinecoind, and store responses.
...
class CompactBlocksTest(MachinecoinTestFramework):
    ...
    # This test actually causes machinecoind to (reasonably!) disconnect us, so do this last.
    ...
    # machinecoind's choice of nonce.
    ...
    # Test that machinecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for machinecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # machinecoind will not send blocktxn responses for blocks whose height is
