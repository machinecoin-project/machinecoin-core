...
#ifndef MACHINECOIN_TXMEMPOOL_H
#define MACHINECOIN_TXMEMPOOL_H
...
struct LockPoints
{
    ...
    // constraints (MIP68) of this tx given our view of block chain history
    int height;
    int64_t time;
