...
#ifndef MACHINECOIN_QT_MACHINECOINGUI_H
...
/**
  Machinecoin GUI main class. This class represents the main window of the Machinecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MachinecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MachinecoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~MachinecoinGUI();
...
#endif // MACHINECOIN_QT_MACHINECOINGUI_H
