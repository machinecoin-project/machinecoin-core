Download URL: https://sourceforge.net/projects/machinecoin/files/Machinecoin/machinecoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MAC fee schedule (users still pay 0.01 MAC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #machinecoin00 - #machinecoin99
