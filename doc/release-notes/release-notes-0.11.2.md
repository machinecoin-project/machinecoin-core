Machinecoin Core version 0.11.2 is now available from:

  <https://machinecoin.org/bin/machinecoin-core-0.11.2/>
...
- Block versions over the last 50,000 blocks as progress towards BIP65
  consensus enforcement: <http://machinecoin.sipa.be/ver-50k.png>

- Block versions over the last 2,000 blocks showing the days to the
  earliest possible BIP65 consensus-enforced block: <http://machinecoin.sipa.be/ver-2k.png>
...
[BIP65]: https://github.com/machinecoin-project/bips/blob/master/bip-0065.mediawiki
...
[BIP113]: https://github.com/machinecoin-project/bips/blob/master/bip-0113.mediawiki
...
- #6600 `1e672ae` Debian/Ubuntu: Include machinecoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split machinecoin-tx into its own package
