 ...
 */
class CMachinecoinAddress : public CBase58Data {
public:
    ...
    CMachinecoinAddress() {}
    CMachinecoinAddress(const CTxDestination &dest) { Set(dest); }
    CMachinecoinAddress(const std::string& strAddress) { SetString(strAddress); }
    CMachinecoinAddress(const char* pszAddress) { SetString(pszAddress); }
