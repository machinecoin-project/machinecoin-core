...
void MasternodeList::updateMyMasternodeInfo(QString strAlias, QString strAddr, const COutPoint& outpoint)
{
    ...
    QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(fFound ? EncodeDestination(GetScriptForDestination(CScriptID(infoMn.pubKeyCollateralAddress.GetID()))) : ""));
...
void MasternodeList::updateNodeList()
{
    ...
    for(auto& mnpair : mapMasternodes)
    {
        ...
        QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(EncodeDestination(GetScriptForDestination(CScriptID(mn.pubKeyCollateralAddress.GetID())))));
