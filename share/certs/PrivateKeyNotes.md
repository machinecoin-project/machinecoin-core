...
unlocked to sign the Machinecoin-Qt.app bundle.
...
allowing somebody to distribute a Machinecoin-Qt.app or machinecoin-qt-setup.exe with a valid
...
that the machinecoin-qt.exe file inside the installer had not been tampered with.
