...
static Checkpoints::MapCheckpoints mapCheckpoints =
        ...
        (305275, uint256("0x4222db35707d9af172ea5c23582338874d1f2956b1850f857c50a3e6f2c6f313"))        
        ;
static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1465143555, // * UNIX timestamp of last checkpoint block
        336611,     // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04662b332bc0e8759be372dcb9a54e0209d9d65958eb7f26f5e37308f810689e0504eed778c2677a860361148f914fcb591843c42064b2747d21a0f23c776e7a6d");
        nDefaultPort = 40333;
        ...
        genesis.nNonce   = 3716037;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x6a1f879bcea5471cbfdee1fd0cb2ddcc4fed569a500e352d41de967703e83172"));
        assert(genesis.hashMerkleRoot == uint256("0x36a9e41063f3e71466299d0ed9e8193c1c802a88b286016fa4a4d0c3bc384a5c"));

        vSeeds.push_back(CDNSSeedData("machinecoin.org", "dnsseed.machinecoin.org"));
        ...
        // Machinecoin: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("machinecoin.org", "testnet-dnsseed.machinecoin.org"));
        ...
        // Machinecoin: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        // Machinecoin: v2 enforced using Bitcoin's supermajority rule
