...
#ifndef MACHINECOIN_QT_MACHINECOINUNITS_H
#define MACHINECOIN_QT_MACHINECOINUNITS_H
...
/** Machinecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MachinecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MachinecoinUnits(QObject *parent);

    /** Machinecoin units.
      @note Source: https://en.machinecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MAC,
...
typedef MachinecoinUnits::Unit MachinecoinUnit;

#endif // MACHINECOIN_QT_MACHINECOINUNITS_H
