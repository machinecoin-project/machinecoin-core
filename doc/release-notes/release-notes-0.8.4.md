...
code, causing the Machinecoin-Qt or machinecoind process to crash.
...
Linux: clicking on machinecoin: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of Machinecoin against Boost versions 1.50-1.52.
