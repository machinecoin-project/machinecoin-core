...
#ifndef MACHINECOIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define MACHINECOIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // MACHINECOIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
